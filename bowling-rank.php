...
<?php $sql = ("SELECT PlayerId, PlayerName, PlayerEmail, Score FROM player, scoreg1  WHERE player.PlayerId = scoreg1.PlayerFK ORDER BY Score DESC");?>
        ...
        <div class="row">
          <div class="col-lg-6 mb-4">
            <div class="card" style="width: 18rem;">
              <div class="card-body">
              <img class="card-img-top" src="assets/img/portfolio/ch1-bowlling.jpg" alt="Card image cap">
                <div class="card-body">
                  <!-- <h5 class="card-title">First Place</h5> --> 
                  <p class="card-text"><?php echo $row['PlayerName'] ?></p>
                </div>
                <ul class="list-group list-group-flush">
                  <li class="list-group-item"><?php echo $row['Score'] ?></li>
                </ul>
      
                <div class="card-body">
                  <a href="#" class="card-link">Request for challenge</a>
                </div>
                </div> 
            </div>
          </div>
